...
namespace Application.Features.Cars.Queries
{
    public class GetCarListByUnderMaintenanceQuery : IRequest<CarListModel>, ICachableRequest
    {
        ...
        public class GetCarListByUnderMaintenanceQueryQueryHandler : IRequestHandler<GetCarListByUnderMaintenanceQuery, CarListModel>
        {
            public readonly ICarRepository _carRepository;
            public readonly IMapper _mapper;

            public GetCarListByUnderMaintenanceQueryQueryHandler(ICarRepository carRepository, IMapper mapper)
            {
