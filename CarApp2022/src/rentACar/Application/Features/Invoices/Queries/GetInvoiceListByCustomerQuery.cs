...
public class GetInvoiceListByCustomerQuery : IRequest<InvoiceListModel>
{
    ...
    public class GetListInvoiceByCustomerQueryHandler : IRequestHandler<GetInvoiceListByCustomerQuery, InvoiceListModel>
    {
        ...
        public async Task<InvoiceListModel> Handle(GetInvoiceListByCustomerQuery request,
