    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 500.0, 1, "", "kangoo", 1 });

            migrationBuilder.InsertData(
                table: "Models",
                columns: new[] { "Id", "BrandId", "DailyPrice", "FuelId", "ImageUrl", "Name", "TransmissionId" },
                values: new object[] { 2, 2, 1000.0, 2, "", "civic", 2 });

            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "State", "ColorId", "ModelId", "ModelYear", "Plate" },
                values: new object[] { 1, 1, 1, 1, (short)2012, "06ABC06" });

            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "State", "ColorId", "ModelId", "ModelYear", "Plate" },
                values: new object[] { 2, 1, 2, 2, (short)2015, "01DEF01" });
